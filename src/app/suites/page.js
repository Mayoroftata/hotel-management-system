  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="container mx-auto my-5 px-4 py-8">
        {/* Header Section */}
        <h1 className="text-3xl text-gray-800 font-bold mb-4">Our Suites.</h1>
        <p className="text-gray-600 mb-8">
          Choose our best suites with spacious walk-in closets, Italian marble
          bathrooms, teak floors, and oak wood desks. Breathe easy with
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex mt-4 space-x-4">
              <button className="bg-blue-600 rounded-md text-white duration-300 hover:bg-blue-700 px-4 py-2 transition">
                <Link href="/suites/suite2">EXPLORE</Link>
              </button>
              <button className="bg-yellow-500 rounded-md text-white duration-300 hover:bg-yellow-600 px-4 py-2 transition">
                <Link href="/suites/suite2">BOOK</Link>
              </button>
            </div>
          </div>
        </div>

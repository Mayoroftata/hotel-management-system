            ...
            <div className='justify-center flex items-center  min-h-screen bg-blue-900'>
                <div className='bg-white  w-full max-w-lg mx-6 border border-white/20 shadow rounded'>
                    ...
                    <div className='px-5 pb-5 space-y-2'>
                        ...
                        <div>
                            <button onClick={googleSign} type='button' className='bg-blue-900 rounded-lg w-full py-1 flex items-center justify-center'><Image alt='google' src="/images/google.svg" width={23} height={1} /></button>
                        </div>
                    </div>
                </div>
            </div>

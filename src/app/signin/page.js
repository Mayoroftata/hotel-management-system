                    ...
                    <div className='px-5 pb-5 space-y-2'>
                        ...
                        <form onSubmit={handleSubmit} className='space-y-2.5'>
                            <div>
                                <input
                                    ...
                                    className={`p-2 w-full border border-gray-300 rounded-lg focus:outline-none ${errors.email && touched.email ? "border-red-500" : "focus:border-blue-900"}`}
                                    type="email"
                                    placeholder='Email'
                                />
                            ...
                            <div>
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`p-2 w-full border border-gray-300 rounded-lg focus:outline-none ${errors.password && touched.password ? "border-red-500" : "focus:border-blue-900"}`}
                                    type="password"
                        ...
                        <div>
                            <p className='text-center pt-2 text-gray-500'>
                                ...
                                <Link href="/signup" className='text-blue-900 underline font-semibold'>
                                    Sign up
                                </Link>
                            </p>
                        </div>
                        ...
                        <div className=''>
                            <button onClick={googleSign} type='button' className='bg-blue-900 rounded-lg w-1/3 py-1 flex items-center justify-center'>
                                <Image alt='google' src="/images/google.svg" width={23} height={1} />
                            </button>
                           
                            {/* <button className='bg-blue-900 rounded-lg w-1/3 py-1 flex items-center justify-center'>
                                <Image alt='github' src="/images/github.svg" width={30} height={1} />
                            </button>
                            <button onClick={facebookSign} type='button' className='bg-blue-900 rounded-lg w-1/3 py-1 flex items-center justify-center'>
                                <Image alt='facebook' src="/images/facebook.svg" width={21} height={1} />
                            </button> */}
                        </div>
                    </div>
                </div>
